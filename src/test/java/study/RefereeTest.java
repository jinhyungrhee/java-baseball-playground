...
public class RefereeTest {
    ...
    static Stream<Arguments> generateData() {
        return Stream.of(
                ...
                Arguments.of(Arrays.asList(1, 2, 9), "2스트라이크"),
                Arguments.of(Arrays.asList(7, 8, 9), "낫싱"),
                Arguments.of(Arrays.asList(2, 3, 1), "3볼"),
                Arguments.of(Arrays.asList(1, 3, 2), "2볼 1스트라이크"),
                Arguments.of(Arrays.asList(2, 4, 3), "1볼 1스트라이크")
        );
    }
